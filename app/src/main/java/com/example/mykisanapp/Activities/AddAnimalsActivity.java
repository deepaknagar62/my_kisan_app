...
public class AddAnimalsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textphone = findViewById(R.id.editTextPhone2aa);
        textvillage = findViewById(R.id.editTextVillage2aa);
        textabout = findViewById(R.id.editTextAboutaa);
        tprice = findViewById(R.id.editTextPriceaa);
        imageView = findViewById(R.id.imageView23);
        buttonChooseImage = findViewById(R.id.buttonChooseImage2);
        buttonCreatePerson = findViewById(R.id.buttonCreatePerson2aa);

        sharedPrefManager = new SharedPrefManager(AddAnimalsActivity.this);
    ...
    private void createPerson() {
        String phonetxt = textphone.getText().toString().trim();
        String villagetxt = textvillage.getText().toString().trim();
        ...
        String type_crop = "animals";
        DateFormat dfrom = new SimpleDateFormat("dd/MM/yyyy");
        Date obj = new Date();
        String date = (dfrom.format(obj)).toString();


        if ( price.isEmpty() || userId.isEmpty() || type_crop.isEmpty()  || phonetxt.isEmpty() || about_sell.isEmpty()  || villagetxt.isEmpty() || imageUri == null) {
        ...
        RequestBody phonePart = RequestBody.create(MediaType.parse("text/plain"), phonetxt);
        RequestBody villagePart = RequestBody.create(MediaType.parse("text/plain"), villagetxt);
        ...
        call.enqueue(new Callback<UserEntry>() {
            ...
            public void onResponse(Call<UserEntry> call, Response<UserEntry> response) {
                ...
                if(response.isSuccessful()){
                    Toast.makeText(AddAnimalsActivity.this, "Succefully Uploaded..", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AddAnimalsActivity.this, "Failed to upload.." + response.code(), Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<UserEntry> call, Throwable t) {
                Toast.makeText(AddAnimalsActivity.this, "Submitted successfully..", Toast.LENGTH_SHORT).show();
            }
        });
